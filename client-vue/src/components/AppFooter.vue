<template>
  <footer class="bg-blue-900 text-white py-6 border-t border-blue-800 relative z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
        <!-- Logo et nom de la mairie à gauche -->
        <div class="flex items-center mb-4 md:mb-0">
          <img src="@/assets/image.png" alt="Mairie de Cotonou" class="h-12 w-auto mr-3" />
          <div>
            <h3 class="text-lg font-semibold text-white">Mairie de Cotonou</h3>
          </div>
        </div>
      ...
      <div class="text-center mt-6">
        <p class="text-sm text-gray-300">© 2025 Mairie de Cotonou. Tous droits réservés.</p>
      </div>
    </div>
  </footer>
</template>
...
// Pas de logique spécifique requise pour ce composant
</script>
