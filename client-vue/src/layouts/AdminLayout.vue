...
const navigation = [
  { name: 'Tableau de bord', to: { name: 'admin-dashboard' }, icon: ChartBarIcon },
  { name: 'Employés', to: { name: 'admin-employees' }, icon: UserGroupIcon },
  { name: 'Réclamations', to: { name: 'admin-complaints' }, icon: ExclamationTriangleIcon },
  { name: 'Comptes utilisateurs', to: { name: 'admin-user-accounts' }, icon: UserIcon },
]
