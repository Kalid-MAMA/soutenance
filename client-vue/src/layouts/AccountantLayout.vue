...
const navigation = [
  { name: 'Tableau de bord', to: { name: 'accountant-dashboard' }, icon: ChartBarIcon },
  { name: 'Employés', to: { name: 'accountant-employees' }, icon: UserGroupIcon },
  { name: 'Taux', to: { name: 'accountant-rates' }, icon: CurrencyDollarIcon },
  { name: 'Rapports', to: { name: 'accountant-reports' }, icon: DocumentTextIcon },
]
